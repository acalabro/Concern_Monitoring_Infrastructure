...
//    			+ "</script>"
				...
				+ "    	    window.open(\"./notifications\", \"_blank\", \"toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=900,height=530\");\n"
				+ "    	}\n"
				+ "    	</script>"
				+ "    	<script>\n"
				+ "    	function deleteFunction() {\n"
				+ "    	    window.open(\"./deleterules\", \"_blank\", \"toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=500,height=600\");\n"
				+ "    	}\n"
				+ "    	</script>"
				+ "    	<script>\n"
